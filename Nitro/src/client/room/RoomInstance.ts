...
export class RoomInstance extends Disposable implements IRoomInstance
{
    ...
    public getRoomObjectsForCategory(category: number): IRoomObject[]
    {
        ...
        return (manager ? manager.objects.getValues() as IRoomObject[] : []);
    }
    ...
    public createRoomObject(id: number, stateCount: number, type: string, category: number): IRoomObject
    {
