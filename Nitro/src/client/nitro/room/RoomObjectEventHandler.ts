...
export class RoomObjectEventHandler extends Disposable implements IRoomCanvasMouseListener
{
    ...
    private _Str_18155(roomObject: IRoomObject, selectedObjectData: SelectedRoomObjectData, x: number, y: number, stackingHeightMap: FurnitureStackingHeightMap): boolean
    {
    ...
    private _Str_22090(k: IRoomObject, _arg_2: SelectedRoomObjectData, _arg_3: IVector3D, _arg_4: IVector3D, _arg_5: IVector3D, _arg_6: number, _arg_7: number, _arg_8: number): boolean
    {
    ...
    private _Str_19271(roomId: number, isTileEvent: boolean, isWallEvent: boolean): void
    {
        ...
        let roomObject: IRoomObject   = null;
    ...
    private _Str_17555(k: IRoomObject, _arg_2: boolean): number
    {
    ...
    private _Str_19253(roomId: number, objectId: number, category: number): void
    {
        ...
        const _local_5 = (this._roomEngine.getRoomObject(roomId, objectId, category) as IRoomObject);
    ...
    private setFurnitureAlphaMultiplier(object: IRoomObject, multiplier: number): void
    {
    ...
    private _Str_25586(roomObject: IRoomObject, x: number, y: number, wallGeometry: LegacyWallGeometry): boolean
    {
